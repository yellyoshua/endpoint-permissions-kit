...
const MATRIX: readonly MatrixRow[] = [
  ...
  { user: 'ada', method: 'POST', path: '/inventory/items', body: { ...ITEM_BODY, cost: -1 }, status: 403, code: 'HOOK_ERROR' },
  { user: 'ada', method: 'PATCH', path: '/inventory/items/i1', body: { price: -5 }, status: 403, code: 'HOOK_ERROR' },
  { user: 'ada', method: 'POST', path: '/inventory/warehouses/stock', body: { ...STOCK_BODY, quantity: -1 }, status: 403, code: 'HOOK_ERROR' },
  { user: 'ada', method: 'PATCH', path: '/hr/employees/e1', body: { salary: 0 }, status: 403, code: 'HOOK_ERROR' },
  ...
  { user: 'wes', method: 'PATCH', path: '/inventory/warehouses/stock/s1', body: { quantity: -5 }, status: 403, code: 'HOOK_ERROR' },
  ...
  { user: 'cat', method: 'POST', path: '/billing/invoices', body: { ...INVOICE_BODY, amount: 0 }, status: 403, code: 'HOOK_ERROR' },
  ...
  { user: 'hal', method: 'PATCH', path: '/hr/employees/e1', body: { salary: -1 }, status: 403, code: 'HOOK_ERROR' },
